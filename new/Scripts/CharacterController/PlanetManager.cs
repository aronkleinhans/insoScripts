...
namespace Insolence
{
    public class PlanetManager : MonoBehaviour, IMoverController
    {
        ...
        private List<CharacterControl> _characterControllersOnPlanet = new List<CharacterControl>();
